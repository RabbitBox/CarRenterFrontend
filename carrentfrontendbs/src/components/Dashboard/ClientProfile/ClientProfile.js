    ...
    return(
        <div className="container" id="profil-container">
            ...
            <p className="text-center fb">User informations and statistcs, spendings, following, reservationst
                and more.</p>
            <div className="row">
                <div className="col profil-col"><img id="profil-img" style={{height: "410px", marginTop: "15px"}} src={props.client.imgUrl}/></div>
                <div className="col profil-col">
                    ...
                    <div id="profil-btns">
                        <div className="btn-group" role="group">
                            <button className="btn btn-warning btn-make-profile" type="button"><i
